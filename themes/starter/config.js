...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_2: '市场没有证明你是对的，你就是错的', // 英雄区文字
  ...
  STARTER_ABOUT_TITLE: '坚持做对的事，时间会证明你是对的',
  STARTER_ABOUT_TEXT:
    '只有成功才是成功他妈。你失败了一百次，第一百零一次失败，这个失败也不是成功他妈。 <br /> <br /> 永远不要对你期待的事情抱有不切实际的幻想',
  ...
  STARTER_BLOG_TITLE: 'z家军，z家村，闷声发大财',
  STARTER_BLOG_COUNT: 3, // 首页博文区块默认展示前3篇文章
  STARTER_BLOG_TEXT_1: '不要对票有感情，谁是县长不重要，重要的是你要当县长夫人',
  STARTER_BLOG_TEXT_2:
    '现在赚钱还是以后赚大钱',
